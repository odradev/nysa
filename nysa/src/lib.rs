...
fn path_stack_default_impl() -> Vec<Item> {
    vec![
        parse_quote! {
...
mod tests {
    ...
    #[test]
    fn test_parser() {
        let result: PackageDef = parse(String::from(include_str!("../../resources/plascoin.sol")));
        // let result: PackageDef = parse(TEST_INPUT.to_string());
